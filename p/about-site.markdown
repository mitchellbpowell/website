...
Most recently, I've started keeping the source files on Git, which has been interesting. My GitHub repository for this site, as rudimentary as my work is so far, is [here](https://github.com/mitchellbpowell/website).
